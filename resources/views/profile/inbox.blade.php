...
<style>
    ...
    .gmail-row {
        ...
        text-decoration: none;
        color: inherit;
        background-color: #f2f6fc; /* Unread style */
    }
    ...
    .gmail-row.read .gmail-sender {
        font-weight: 400;
    }
    
    .gmail-subject-container {
        flex: 1;
        display: flex;
        align-items: center;
        white-space: nowrap;
    ...
    .gmail-row.read .gmail-date {
        font-weight: 400;
        color: #5f6368;
    }
    
    /* Custom Scrollbar */
    .gmail-list::-webkit-scrollbar {
        width: 8px;
    }
