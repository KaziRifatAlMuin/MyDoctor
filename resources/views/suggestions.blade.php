            ...
            <div class="ai-summary-card" id="aiSummaryCard">
                <div class="ai-summary-title">
                    <span class="ai-summary-title-left">
                        ...
                        <span>Health Summary of You</span>
                    </span>
                ...
                <div class="ai-summary-note">
                    Generated by MyDoctor AI using your latest health data.
                </div>
                <div class="ai-summary-body" id="aiSummaryBody">
                    <span class="ai-summary-loading">
                        <i class="fas fa-circle-notch fa-spin"></i>
                        Preparing your personalized AI summary...
                    </span>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        async function loadAiSummary(forceRefresh = false) {
            ...
            target.innerHTML = '<span class="ai-summary-loading"><i class="fas fa-circle-notch fa-spin"></i>Preparing your personalized AI summary...</span>';
            ...
            try {
                ...
                const reply = typeof data.reply === 'string' && data.reply.trim() !== ''
                    ? data.reply
                    : 'Unable to generate AI summary right now. Please try again in a moment.';
                ...
                target.innerHTML = '<p class="mb-0">Unable to generate AI summary right now. Please try again in a moment.</p>';
            }
        }
        ...
        function renderChatbotMarkup(text) {
            ...
            return html || '<p class="mb-0">No AI summary available.</p>';
        }
